 ...
 *******************************************************************************/
package org.eclipse.leshan.client.demo.clientcore.engine;
...
import org.eclipse.leshan.client.demo.clientcore.EndpointsManager;
import org.eclipse.leshan.client.demo.clientcore.RegistrationUpdate;
...
import org.eclipse.leshan.client.demo.clientcf.request.LwM2mRequestSender;
...
import org.eclipse.leshan.client.demo.clientcore.servers.DmServerInfo;
import org.eclipse.leshan.client.demo.clientcore.servers.ServerIdentity;
import org.eclipse.leshan.client.demo.clientcore.servers.ServerInfo;
import org.eclipse.leshan.client.demo.clientcore.servers.ServersInfoExtractor;
import org.eclipse.leshan.client.demo.clientcore.util.LinkFormatHelper;
...
public class DefaultRegistrationEngine implements RegistrationEngine {
    ...
    public void start() {
        ...
        synchronized (this) {
            ...
            ServerIdentity serverIdentity = factoryBootstrap();
            ...
            if (serverIdentity == null) {
                ...
                //服务注册-->3
                LOG.error("服务启动---->> "+"提交注册 ：{}",JSONUtil.toJsonStr(serverIdentity));
                registerFuture = schedExecutor.submit(new RegistrationTask(serverIdentity));
            }
        }
    }
    ...
    private Status register(ServerIdentity server) throws InterruptedException {
        ...
        try {
            ...
            if (response == null) {
                ...
                //更新服务
                LOG.error("服务启动---->>"+"注册成功，registrationID： {}，且不开启注册更新服务",registrationID );

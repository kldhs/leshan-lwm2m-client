...
import static org.eclipse.leshan.client.demo.clientcore.object.Security.*;
...
import org.eclipse.leshan.client.demo.clientcf.LeshanClient;
import org.eclipse.leshan.client.demo.clientcf.LeshanClientBuilder;
import org.eclipse.leshan.client.demo.clientcore.engine.DefaultRegistrationEngineFactory;
import org.eclipse.leshan.client.demo.clientcore.object.Server;
import org.eclipse.leshan.client.demo.core.object.LwM2mObjectEnabler;
import org.eclipse.leshan.client.demo.core.object.ObjectsInitializer;
...
public class LeshanClientDemo {
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort, boolean needBootstrap,
        ...
        LOG.error("服务启动---->> "+"创建资源对象、实例 : "+enablers.stream().map(a -> String.valueOf(a.getId())).collect(Collectors.joining(",")));
        // Create CoAP Config

 ...
 *******************************************************************************/
package org.eclipse.leshan.client.demo.clientcf;
...
import org.eclipse.leshan.client.demo.clientcore.LwM2mClient;
import org.eclipse.leshan.client.demo.clientcore.RegistrationUpdateHandler;
import org.eclipse.leshan.client.demo.clientcore.bootstrap.BootstrapHandler;
import org.eclipse.leshan.client.demo.clientcf.bootstrap.BootstrapResource;
import org.eclipse.leshan.client.demo.clientcf.object.ObjectResource;
import org.eclipse.leshan.client.demo.clientcf.request.CaliforniumLwM2mRequestSender;
import org.eclipse.leshan.client.demo.clientcore.engine.RegistrationEngine;
import org.eclipse.leshan.client.demo.clientcore.engine.RegistrationEngineFactory;
import org.eclipse.leshan.client.demo.clientcore.observer.LwM2mClientObserver;
import org.eclipse.leshan.client.demo.clientcore.observer.LwM2mClientObserverAdapter;
import org.eclipse.leshan.client.demo.clientcore.observer.LwM2mClientObserverDispatcher;
import org.eclipse.leshan.client.demo.core.object.LwM2mObjectEnabler;
import org.eclipse.leshan.client.demo.core.object.LwM2mObjectTree;
import org.eclipse.leshan.client.demo.clientcore.resource.listener.ObjectListener;
import org.eclipse.leshan.client.demo.clientcore.resource.listener.ObjectsListenerAdapter;
    ...
    protected CoapServer createCoapServer(NetworkConfig coapConfig, ScheduledExecutorService sharedExecutor) {
        ...
        CoapServer coapServer = new CoapServer(coapConfig) {
            ...
            protected Resource createRoot() {
                ...
                return new RootResource(engine, bootstrapHandler, this);
            }
        };

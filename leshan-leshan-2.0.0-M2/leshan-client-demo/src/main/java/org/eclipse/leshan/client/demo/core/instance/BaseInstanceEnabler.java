 ...
 *******************************************************************************/
package org.eclipse.leshan.client.demo.core.instance;
...
import org.eclipse.leshan.client.demo.clientcore.resource.ResourceChangedListener;
...
public class BaseInstanceEnabler implements LwM2mInstanceEnabler {
    private static final Logger LOG = LoggerFactory.getLogger(BaseInstanceEnabler.class);
    ...
    public void fireResourcesChange(int... resourceIds) {
       LOG.error("资源更新---->> "+"resourceIds : {}", Arrays.stream(resourceIds).mapToObj(a -> String.valueOf(a)).collect(Collectors.joining(",")));

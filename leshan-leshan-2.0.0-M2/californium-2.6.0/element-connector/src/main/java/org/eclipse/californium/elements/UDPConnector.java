...
import org.eclipse.californium.elements.util.CRC16Util;
		...
		protected void work() throws InterruptedException {
			...
			if (currentSocket != null) {
				try {
					...
					LOGGER.error("UDP发送---->> "+"byte : {}",datagram.getData());
					LOGGER.error("UDP发送---->> "+"hex : {}",DatatypeConverter.printHexBinary(datagram.getData()));
